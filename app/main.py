...
# app = FastAPI(
#     title="AI Symptom Checker API",
#     description="Multi-class disease prediction with Top-3 ranking",
#     version="3.0"
# )
...
#         raise HTTPException(
#             status_code=400,
#             detail="Invalid categorical input provided. Use correct values."
#         )
...
#     # Risk evaluation based on highest probability
#     highest_confidence = top3_predictions[0]["confidence_percentage"]
#     risk_level = calculate_risk(highest_confidence, data)
...
# app = FastAPI(
#     title="AI Symptom Checker API",
#     description="ML-based disease risk prediction with rule-based risk stratification",
#     version="1.0"
# )
...
# # Risk Calculation Logic
# # -----------------------------
# def calculate_risk(probability, data):

#     # Primary probability-based logic
#     if probability > 0.75:
#         return "High"
...
#     risk = calculate_risk(probability, data)
#     action = recommend_action(risk)
#     explanation = generate_explanation(data)

#     return {
#         "prediction": {
#             "disease_risk_probability": round(
#                 float(probability), 3
#                 ),
